    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try { 
                ...
                // If user types text here, it jumps straight to CATCH
                ...
                switch (choice) {
                    ...
                    case 1: // Add Bookmark
                        ...
                        if (type == 1) {
                            ...
                            book = new Manga(title, page, chapter, artist);
                        } else if (type == 2) {
                            System.out.print("Enter author: ");
                            String author = cin.nextLine();
                            book = new Novel(title, page, chapter, author);
                        } else if (type == 3) {
                            System.out.print("Enter subject: ");
                            String subject = cin.nextLine();
                            book = new Textbook(title, page, chapter, subject);
                        } else {
                    ...
                    case 3: // Update Bookmark
                        if (bookmarks.isEmpty()) {
                            System.out.println("You made no bookmarks, nothing to update.");
                            break;
                        }
                        ...
                        if (toUpdate instanceof Manga) {
                            System.out.print("Enter new artist (leave blank to keep current): ");
                            String newArtist = cin.nextLine();
                            if (!newArtist.isEmpty()) ((Manga) toUpdate).setArtist(newArtist);
                        } else if (toUpdate instanceof Novel) {
                            System.out.print("Enter new author (leave blank to keep current): ");
                            String newAuthor = cin.nextLine();
                            if (!newAuthor.isEmpty()) ((Novel) toUpdate).setAuthor(newAuthor);
                        } else if (toUpdate instanceof Textbook) {
                            System.out.print("Enter new subject (leave blank to keep current): ");
                            String newSubject = cin.nextLine();
                            if (!newSubject.isEmpty()) ((Textbook) toUpdate).setSubject(newSubject);
                        }
